...
import Cogwheel from '@/assets/svg/track/cogwheel-icon.svg';
import Talk from '@/assets/svg/track/talk-icon.svg';
import Enhance from '@/assets/svg/track/enhance-icon.svg';
