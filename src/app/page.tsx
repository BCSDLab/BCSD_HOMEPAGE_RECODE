  ...
  return (
    <div>
      <header className="relative h-[800px] w-full">
        <Image src="https://image.bcsdlab.com/bcsd_main_page_image.png" alt="main Image" fill sizes="100vw" priority />
        <div className="absolute inset-0 flex">
          <div className="font-inter relative top-50 left-20 m-4 rounded-md text-[40px] font-semibold text-white">
            ...
            <Link
              ...
              className="inline-block rounded-[10px] bg-[#D365FD] px-[20px] py-[13px]"
            >
      ...
      <div className="min-h-screen gap-16">
        <div className="space-y-20">
          <div className="flex justify-between px-[120px] pt-[120px] pb-0">
            <div className="space-y-4">
              <p className="text-[34px] leading-[0] font-medium text-[#414141]">열린 공간 BCSD</p>
              <p className="mt-[13px]">
